...
<div class="card">
        <div class="card-body">
            <h4 class="card-title">Manage Admin Account</h4>
            ...
            <table id="demo-foo-addrow2" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->is_active == 1)
                                <a href="{{route('super.activate.admin',['id'=>$item->id])}}">
                        ...
                        <td>
                            <a href="{{route('super.reset.admin',['id'=>$item->id])}}">
                        ...
                        <tr>
                                <td colspan="2">
                                        <button type="button" 
                                                ...
                                                data-toggle="modal" 
                                                data-target="#add-contact"><i class="fa fa-paper-plane"></i> &nbsp Invite Admin
                                        </button>
                                </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal form-material" method="POST" action="{{route('super.add.admin')}}">
                                ...
                                <div id="edit-data" 
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal form-material" method="POST" action="{{route('super.update.admin')}}">
