            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        &nbsp | &nbsp
                        <a href="{{route('super.user.git', ['id'=>$item->id])}}">
                                <i class="fa fa-eye"></i>
                        </a>
                    </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal form-material" method="POST" action="{{route('super.add.git')}}">
                                        {{ csrf_field() }}     
                                        <div class="form-group">
                        ...
                        <div id="add-user" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal form-material" method="POST" action="{{route('super.add.user.git')}}">
                                                {{ csrf_field() }}     
                                                <div class="form-group">
                                                        <div class="col-md-12 m-b-20">
                                    ...
                                    <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal form-material" method="POST" action="{{route('super.update.git')}}">
                                                        {{ csrf_field() }}     
                                                        <div class="form-group">
                                                            <div class="col-md-12 m-b-20">
                ...
                $('.edit-data').click(function () {
                    ...
                    $.ajax({
                            ...
                            success: function (data) {
                                ...
                                $('#server_id').val(data.data.server_list_id);
