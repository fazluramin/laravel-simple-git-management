            ...
            <table id="demo-foo-addrow2" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->is_active == 1)
                                <a href="{{route('admin.activate.user',['id'=>$item->id])}}">
                        ...
                        <td>
                            <a href="{{route('admin.reset.user',['id'=>$item->id])}}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal form-material" method="POST" action="{{route('admin.add.user')}}">
                                ...
                                <div id="edit-data" 
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal form-material" method="POST" action="{{route('admin.update.user')}}">
