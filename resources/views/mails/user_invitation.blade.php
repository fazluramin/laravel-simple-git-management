            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:19px; color:#30373b;  font-weight:bold;"><span style="color:#feae39;">@First Name</span> has invited you to join Our Company!</td>
                  </tr>
                  <tr>
                    <td height="30" class="em_height">&nbsp;</td>
                  </tr>
                      ...
                      <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;">
                            <a href="{{ route('user.register', $data->user_invited_token)}}" target="_blank" style="text-decoration:none; color:#ffffff; display:block; line-height:45px;">Accept Invitation</a></td>
                        </tr>
                      </table>
                    </td>
                  </tr>
